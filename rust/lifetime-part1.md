...
Давайте начнём писать код реализации нашей задачи:
...
Этот код правильный и компилируется. Реализовали всё, что требовалось задачей,
кроме доступа к текстовым данным. Что собственно сейчас и начнём делать.
